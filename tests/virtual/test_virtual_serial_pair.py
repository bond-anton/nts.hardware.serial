...
try:
    from src.nts.hardware.serial.utilities.mock import mock_openpty
    from src.nts.hardware.serial.config import SerialConnectionMinimalConfig
    from src.nts.hardware.serial.virtual.virtual_serial_pair import (
        VirtualSerialPair,
    )
except ModuleNotFoundError:
    from nts.hardware.serial.utilities.mock import mock_openpty
    from nts.hardware.serial.config import SerialConnectionMinimalConfig
    from nts.hardware.serial.virtual.virtual_serial_pair import VirtualSerialPair
