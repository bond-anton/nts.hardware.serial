...
try:
    ...
    from src.nts.hardware.serial.config import SerialConnectionConfig
    from src.nts.hardware.serial.virtual.virtual_serial_network import (
    ...
    from nts.hardware.serial.virtual.virtual_serial_network import (
        VirtualSerialNetwork,
    )
