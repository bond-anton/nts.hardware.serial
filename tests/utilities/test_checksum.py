...
try:
    from src.nts.hardware.serial.utilities.checksum import check_sum, lrc, check_lrc
except ModuleNotFoundError:
    from nts.hardware.serial.utilities.checksum import check_sum, lrc, check_lrc
