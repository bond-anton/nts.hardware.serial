...
try:
    ...
    from src.nts.hardware.serial.config.validation import (
        validate_port,
        validate_baudrate,
        validate_bytesize,
        validate_parity,
    ...
    from src.nts.hardware.serial.config.defaults import (
    ...
    from nts.hardware.serial.config.validation import (
        validate_port,
        validate_baudrate,
        validate_bytesize,
        validate_parity,
    ...
    from nts.hardware.serial.config.defaults import (
        DEFAULT_BAUDRATE_LIST,
        DEFAULT_BAUDRATE,
        DEFAULT_BYTESIZE,
        DEFAULT_BYTESIZE_LIST,
