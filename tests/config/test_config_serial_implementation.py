...
try:
    from src.nts.hardware.serial.config.exceptions import (
        SerialConnectionConfigError,
    )
    from src.nts.hardware.serial.config.serial_connection_implementation import (
        SerialConnectionConfig as Config,
    )
    from src.nts.hardware.serial.config.defaults import DEFAULT_TIMEOUT
except ModuleNotFoundError:
    from nts.hardware.serial.config.exceptions import (
        SerialConnectionConfigError,
    )
    from nts.hardware.serial.config.serial_connection_implementation import (
        SerialConnectionConfig as Config,
    )
    from nts.hardware.serial.config.defaults import DEFAULT_TIMEOUT
