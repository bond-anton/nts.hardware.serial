...
try:
    from src.nts.hardware.serial.utilities.modbus import modbus_connection_config
    from src.nts.hardware.serial.config import (
        ModbusSerialConnectionConfig as Config,
    )
    from src.nts.hardware.serial.server.rs485_server import RS485Server, SERVER_INFO
except ModuleNotFoundError:
    from nts.hardware.serial.utilities.modbus import modbus_connection_config
    from nts.hardware.serial.config import ModbusSerialConnectionConfig as Config
    from nts.hardware.serial.server.rs485_server import RS485Server, SERVER_INFO
