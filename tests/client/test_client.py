...
try:
    from src.nts.hardware.serial.client import RS485Client
    from src.nts.hardware.serial.utilities.numeric import (
        ByteOrder,
        combine_32bit,
        to_signed32,
    )
    ...
    from nts.hardware.serial.utilities.numeric import ByteOrder
